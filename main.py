...
# 1. Setup components
compressor = HCS3D(28800, sr=[0.57, 0.57, 1.0], Phi_names=["SUBSAMPLING", "SUBSAMPLING", "IDENTITY"], Psi_names=["DCT", "DCT", "DCT"])
...
rec = visuals.to_false_color(visuals.load_reconstruction("results\\HCS 3D\\reconstructions\\220028_IndianPines_recon.npz"))
plt.figure()
plt.subplot(1, 2, 1)
plt.imshow(orig)
plt.subplot(1, 2, 2)
